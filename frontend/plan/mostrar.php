               ...
               <div class="main-content">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="card" style="min-height: 485px">
                                ...
                                <br>
                                <a href="../plan/nuevo.php" class="btn btn-danger text-white"
                            >Nuevo plan</a>
                            <br>
...
if($sentencia){
  while($r = $sentencia->fetchObject()){
   ...
   <?php if(count($data)>0):?> 
    ...
    <a class="btn btn-primary text-white" href="../plan/foto.php?id=<?php echo  $g->idplan; ?>"><i class='material-icons' data-toggle='tooltip' title='crear'>photo_camera</i></a>
