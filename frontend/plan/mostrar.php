                ...
                <div class="row ">
                    <div class="col-lg-12 col-md-12">
                        <div class="card" style="min-height: 485px">
                            ...
                            <br>
                            <a href="../plan/nuevo.php" class="btn btn-danger text-white">Nueva Categoria de Servicio</a>
                            <br>
                                ...
                                <table class="table table-hover" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="../../backend/img/subidas/<?php echo $g->foto ?>" width='90'>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-warning text-white"
                                                    href="../plan/actualizar.php?id=<?php echo  $g->idplan; ?>"><i
                                                        class='material-icons' data-toggle='tooltip'
                                                        title='editar'>edit</i></a>
                                                <a class="btn btn-danger text-white"
                                                    href="../plan/eliminar.php?id=<?php echo  $g->idplan; ?>"><i
                                                        class='material-icons' data-toggle='tooltip'
                                                        title='cancelar'>cancel</i></a>

                                                <a class="btn btn-primary text-white"
                                                    href="../plan/foto.php?id=<?php echo  $g->idplan; ?>"><i
                                                        class='material-icons' data-toggle='tooltip'
                                                        title='crear'>photo_camera</i></a>

                                                <a class="btn btn-dark text-white"
                                                    href="../plan/informacion.php?id=<?php echo  $g->idplan; ?>"><i
                                                        class='material-icons' data-toggle='tooltip'
