                ...
                <div class="row ">
                    <div class="col-lg-12 col-md-12">
                        <div class="card" style="min-height: 485px">
                            ...
                            <br>
                            <a href="../categoria/nuevo.php" class="btn btn-danger text-white">Nueva categoria</a>
                            <br>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-warning text-white"
                                                    href="../categoria/actualizar.php?id=<?php echo  $g->idcate; ?>"><i
                                                        class='material-icons' data-toggle='tooltip'
                                                        title='editar'>edit</i></a>
                                                <a class="btn btn-danger text-white"
                                                    href="../categoria/eliminar.php?id=<?php echo  $g->idcate; ?>"><i
                                                        class='material-icons' data-toggle='tooltip'
