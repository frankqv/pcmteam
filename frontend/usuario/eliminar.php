                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input disabled type="text" value="<?php echo  $f->nombre  ; ?>"
                                                    class="form-control" name="txtnaame"
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?php echo  $f->usuario  ; ?>"
                                                    class="form-control" name="txtuse" disabled
                                                    placeholder="Nombre de la categoria">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="email" value="<?php echo  $f->correo  ; ?>"
                                                    class="form-control" name="txtmail" disabled
                                                    placeholder="Nombre de la categoria">
                                            </div>
                                        </div>
