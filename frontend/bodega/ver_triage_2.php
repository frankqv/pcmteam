...
$inventario_id = 0;
if (isset($_GET['id'])) $inventario_id = intval($_GET['id']);
elseif (isset($_GET['inventario_id'])) $inventario_id = intval($_GET['inventario_id']);
...
<div class="top-navbar">
    <nav class="navbar navbar-expand-lg" style="background: #f39c12;">
        ...
        <b>             <h4 class="card-title mb-2"><?= h($inventario['producto'] ?? 'Equipo') ?> <small><?= h($inventario['codigo_g'] ?? '') ?></small></h4>
...
<div class="container-fluid mt-3">
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="card-title mb-2"><?= h($inventario['producto'] ?? 'Equipo') ?> <small class="text-muted"><?= h($inventario['codigo_g'] ?? '') ?></small></h4>
            <div class="row">
                <div class="col-md-8">
                    <p><strong>Marca:</strong> <?= h($inventario['marca']) ?> |
                       <strong>Modelo:</strong> <?= h($inventario['modelo']) ?> |
                       <strong>Serial:</strong> <?= h($inventario['serial']) ?></p>
                    <p><strong>Ubicación:</strong> <?= h($inventario['ubicacion']) ?> |
                       <strong>Posición:</strong> <?= h($inventario['posicion']) ?> |
                       <strong>Lote:</strong> <?= h($inventario['lote']) ?></p>
                    <p><strong>Grado:</strong> <?= h($inventario['grado']) ?> |
                       <strong>Disposición:</strong> <?= h($inventario['disposicion']) ?> |
                       <strong>Estado:</strong> <?= h($inventario['estado']) ?></p>
                    <p><strong>Técnico asignado:</strong> <?= h($inventario['tecnico_nombre'] ?? $inventario['tecnico_id']) ?> |
                       <strong>Fecha ingreso:</strong> <?= h($inventario['fecha_ingreso']) ?> |
                       <strong>Última modif.:</strong> <?= h($inventario['fecha_modificacion']) ?></p>
                </div>
                <div class="col-md-4">
                    ...
                    <p><strong>Pulgadas:</strong> <?= h($inventario['pulgadas']) ?> |
                       <strong>Táctil:</strong> <?= h($inventario['tactil']) ?></p>
                </div>
            </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <?php else: ?>
                <p><strong>Fecha:</strong> <?= h($triage['fecha_registro'] ?? $triage['fecha_diagnostico'] ?? '') ?></p>
                <p><strong>Técnico:</strong> <?= h($triage['tecnico_nombre'] ?? $triage['tecnico_id']) ?></p>
                <p><strong>Estado:</strong> <?= h($triage['estado'] ?? $triage['estado_reparacion'] ?? '') ?></p>
                <?php if (!empty($triage['categoria'])): ?>
                    <p><strong>Categoría:</strong> <?= h($triage['categoria']) ?></p>
                <?php endif; ?>
                <?php if (!empty($triage['observaciones'])): ?>
                    <div><strong>Observaciones:</strong><pre><?= h($triage['observaciones']) ?></pre></div>
                <?php endif; ?>
            <?php endif; ?>
        </div>
    </div>
                ...
                <?php foreach ($mantenimientos as $m): ?>
                    <div style="border-bottom:1px solid #eee; padding:8px 0;">
                        <div><strong>Fecha:</strong> <?= h($m['fecha_registro']) ?> |
                             ...
                             <strong>Tipo:</strong> <?= h($m['tipo_proceso']) ?></div>
                        <?php if (!empty($m['observaciones'])): ?>
                            <div style="margin-top:6px;"><strong>Observaciones:</strong><pre><?= h($m['observaciones']) ?></pre></div>
                        <?php endif; ?>
                ...
                <?php foreach ($controles as $c): ?>
                    <div style="border-bottom:1px solid #eee; padding:8px 0;">
                        <div><strong>Fecha control:</strong> <?= h($c['fecha_control']) ?> |
                             ...
                             <strong>Categoría REC:</strong> <?= h($c['categoria_rec']) ?></div>
                        <?php if (!empty($c['burning_test'])): ?>
                            <div style="margin-top:6px;"><strong>Burning Test:</strong><pre><?= h($c['burning_test']) ?></pre></div>
                        <?php endif; ?>
                        <?php if (!empty($c['sentinel_test'])): ?>
                            <div style="margin-top:6px;"><strong>Sentinel Test:</strong><pre><?= h($c['sentinel_test']) ?></pre></div>
                        <?php endif; ?>
                        <?php if (!empty($c['observaciones'])): ?>
                            <div style="margin-top:6px;"><strong>Observaciones:</strong><pre><?= h($c['observaciones']) ?></pre></div>
                        <?php endif; ?>
                    </div>
                <?php endforeach; ?>
            <?php endif; ?>
                ...
                <?php foreach ($partes as $p): ?>
                    <div style="border-bottom:1px dashed #ddd; padding:8px 0;">
                        <div><strong>ID:</strong> <?= h($p['id']) ?> |
                             ...
                             <strong>Marca:</strong> <?= h($p['marca']) ?></div>
                        ...
                        <div style="margin-top:6px;"><strong>Detalles:</strong> <?= h($p['detalles']) ?> |
                            ...
                            <strong>Serial:</strong> <?= h($p['serial']) ?></div>
                    </div>
                <?php endforeach; ?>
            <?php endif; ?>
        </div>
