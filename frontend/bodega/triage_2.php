...
<body class="bg-dark text-light">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="section-border">
                    <h5 class="text-info mb-3">COMPONENTES DE DIAGNÓSTICO</h5>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-8">
                                <div class="input-group">
                                    <input type="number" class="form-control" id="vida_util_disco" value="100" min="0" max="100">
            ...
            <div class="col-md-6">
                ...
                <div class="section-border">
                    ...
                    <div class="equipment-counter">
                        <div id="equiposCounter">1</div>
                        <small>EQUIPOS PROCESADOS HOY</small>
                    </div>
                    
                    <!-- Equipment Image Placeholder -->
                    <div class="mt-3 text-center">
                        <div style="width: 120px; height: 90px; background: #333; border-radius: 8px; margin: 0 auto; display: flex; align-items: center; justify-content: center;">
    ...
    <script>
        ...
        function cargarDatosSesion() {
            ...
            document.getElementById('technicianName').textContent = 'LAURA APARICIO';
        ...
        function actualizarContadorEquipos() {
            ...
            document.getElementById('equiposCounter').textContent = equiposProcesados + 1;
        }
        ...
        function guardarDiagnostico() {
            ...
            // En implementación real, aquí iría la llamada AJAX:
            /*
