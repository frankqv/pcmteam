...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action'])) {
    ...
    if ($_POST['action'] == 'get_stats') {
        ...
        $sqlStats = "SELECT u.nombre, COUNT(bi.id) as total_equipos 
                     ...
                     WHERE u.rol IN ('5','6','7') AND u.estado = '1'
...
// Obtener técnicos
$tecnicos = [];
$resultTec = $conn->query("SELECT id, nombre FROM usuarios WHERE rol IN ('5','6','7') AND estado = '1'");
if ($resultTec) {
...
<head>
    ...
    <style>
        * {
        ...
        .equipment-input:focus, .tech-select:focus {
            outline: none;
            border-color: #FFA500;
