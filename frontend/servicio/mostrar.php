        ...
        <div class="wrapper">
            ...
            <div id="content">
                ...
                <div class="main-content">
                                        ...
                                        <table class="table table-hover" id="example">
                                            ...
                                            <tbody>
                                                <?php foreach ($data as $g): ?>
                                                    <tr>
                                                        <td><img src="../../backend/img/subidas/<?php echo $g->servfoto ?>"
                                                                hight='90' width='40' height='40'></td>
                                                        <!--<td>
                                                --?php 
                                                if ($g->idplan =='1') {
                                                    // code...
                                                    ...
                                                    echo '<span class="badge badge-danger">PLAN PREMIUM</span>';
                                                        ...
                                                        <?php if ($g->estod == 'Activo') { ?>
                                                            <td style="color: #3e5569;"><strong><?php echo $g->ini; ?> -
                                                        ...
                                                        <td style="color: #3e5569;">
                                                            ...
                                                            // Verificar si el servicio está inactivo primero
                                                            if ($esta == 'Inactivo') {
                                                                echo '<span class="text-dark"><strong>Cancelado</strong></span>';
                                                            }
                                                            // Verificar si no hay fecha de fin establecida
                                                            elseif ($fechaEnvio == '0000-00-00' || empty($fechaEnvio)) {
                                                                echo '<span class="badge badge-warning">Pendiente</span>';
                                                            }
                                                            // Si hay fecha válida, calcular diferencia
                                                            else {
                                                                $datetime1 = date_create($fechaEnvio);
                                                                $datetime2 = date_create($fechaActual);
                                                                // Verificar que las fechas se crearon correctamente
                                                                if ($datetime1 && $datetime2) {
                                                                    $contador = date_diff($datetime2, $datetime1); // Cambiado el orden para calcular correctamente
                                                                    // Si la fecha de fin es mayor que la actual (servicio activo)
                                                                    if ($fechaEnvio > $fechaActual) {
                                                                        $diasRestantes = $contador->format('%a');
                                                                        echo '<strong>' . $diasRestantes . ' días</strong>';
                                                                    }
                                                                    // Si la fecha ya pasó (servicio completado)
                                                                    else {
                                                                        echo '<span class="text-success"><strong>Entregado</strong></span>';
                                                                    }
                                                                } else {
                                                                    echo '<span class="badge badge-danger">Fecha inválida</span>';
                                                                }
                                                            }
                                                            ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <?php if ($g->estod == 'Activo') { ?>
                                                                <a class="btn btn-primary text-white"
                                                                    href="../servicio/ver.php?id=<?php echo $g->idservc; ?>"><i
                                                                        class='material-icons' data-toggle='tooltip'
                                                                        title='ver info'>visibility</i></a>
                                                                <a class="btn btn-warning text-white"
                                                                    href="../servicio/actualizar.php?id=<?php echo $g->idservc; ?>"><i
                                                                        class='material-icons' data-toggle='tooltip'
                                                                        title='editar'>edit</i></a>
                                                                <a class="btn btn-danger text-white"
                                                                    href="../servicio/eliminar.php?id=<?php echo $g->idservc; ?>"><i
                                                                        class='material-icons' data-toggle='tooltip'
                                                                        title='cancelar'>cancel</i></a>
                                                                <a class="btn btn-secondary text-white" target="_blank"
                                                                    href="https://api.whatsapp.com/send/?phone=57<?php echo $g->celu; ?>&text=%C2%A1%20Te%20damos%20la%20bienvenida%20nuevamente%20a%20PCMarkett%21"><i
                                                                        class='material-icons' data-toggle='tooltip'
                                                                        title='Contactar_WhatsApp'>smartphone</i></a>
                                                        ...
                                                        -->
                                                                <a class="btn btn-info text-white"
                                                                    href="../servicio/ticket.php?id=<?php echo $g->idservc; ?>"><i
                                                                        class='material-icons' data-toggle='tooltip'
                                                                        title='crear ticket'>print</i></a>
                                                            <?php } else { ?>
                                                                <a class="btn btn-warning text-white"
                                                                    href="../servicio/actualizar.php?id=<?php echo $g->idservc; ?>"><i
                                                                        class='material-icons' data-toggle='tooltip'
                    ...
                    </div><a href="../plan/mostrar.php" class="btn btn-success text-white">Nueva Categoria de Servicio
                        Tecnico</a>
                </div>
            </div>
        </div>
