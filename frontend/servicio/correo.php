                    ...
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="card" style="min-height: 485px">
                            <div class="card-header card-header-text">
                                ...
                                <p class="category">Notificaciones al cliente de este servicio reciente añadidos el dia
                                    de hoy</p>
                            </div>
                            ...
                            <div class="card-content table-responsive">
                                <div class="alert alert-warning">
                                    ...
                                    <br>
                                    <strong>Importante!</strong> Para enviarle una notificacion al correo debe tener
                                    obligatoriamente un correo el cliente
                                </div>
                                <?php
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" value="<?php echo  $f->idclie  ; ?>" name="nombre"
                                                    id="nombre">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-6">
                                            <div class="form-group">
                                                <label for="email">Correo del cliente<span
                                                        class="text-danger">*</span></label>
                                                <input type="text" id="email" name="email"
                                                    value="<?php echo  $f->correo  ; ?>" class="form-control"
                                                    name="txtfin" required placeholder="Correo del cliente">
                                                <input type="hidden" name="txtemail" class="form-control"
                                                    value="<?php echo  $f->correo; ?>" required
                                                    placeholder="ejm: laura">
                                            </div>
                                        </div>
                                    </div>
