...
<form enctype="multipart/form-data" method="POST"  autocomplete="off">
   ...
   <div class="form-group">
    <label for="email">RUC de la empresa<span class="text-danger">*</span></label>
    <input type="text" maxlength="14" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" value="<?php echo  $d->ruc; ?>" class="form-control"  name="txtruc" required placeholder="RUC de la empresa">
...
<form enctype="multipart/form-data" method="POST"  autocomplete="off">
  <div class="row">
    <div class="col-md-12 col-lg-12">
      <div class="form-group">
    <label for="email">Foto del sistema<span class="text-danger">*</span></label>
...
<div class="form-group">
        <div class="col-sm-12">
            <button name='stupdcomffot' class="btn btn-success text-white">Guardar</button>                       
            <a class="btn btn-danger text-white" href="../cuenta/configuracion.php">Cancelar</a>
        </div>
    </div>
</form>
