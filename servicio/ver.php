...
?>
<?php if(isset($_SESSION['id'])) { ?> <!doctype html>
<html lang="es"> <head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <!-- Data Tables -->     <!-- SLIDER REVOLUTION 4.x CSS SETTINGS -->
            ...
            <div class="top-navbar">
                <nav class="navbar navbar-expand-lg">
                    <div class="container-fluid">                         <button type="button" id="sidebarCollapse" class="d-xl-block d-lg-block d-md-mone d-none">
                        ...
                        </button>                         <a class="navbar-brand" href="#"> Servicio Y Pedidos </a>                         <button class="d-inline-block d-lg-none ml-auto more-button" type="button"
                            data-toggle="collapse" data-target="#navbarSupportedContent"
                            aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                            <span class="material-icons">more_vert</span>
                        </button>                         <div class="collapse navbar-collapse d-lg-block d-xl-block d-sm-none d-md-none d-none"
            ...
            <div class="main-content">                 <div class="row ">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="card" style="min-height: 485px">
                            ...
                            </div>                             <div class="card-content table-responsive">                                 <?php
                    ...
                    ?>
                            ...
                            <div class="col-md-12 col-lg-12">
                                <div class="form-group">
                                    <center><img src="../assets/img/subidas/<?php echo  $f->foto  ; ?>"
                                            height="150"></center>                                 </div>
                            </div>
                        </div>-->
                                    <br>
                                    <!-- Datos Nuevos -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12"> 
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <center><img
                                                            src="../assets/img/subidas/<?php echo  $f->servfoto  ; ?>"
                                                            height="150"></center>
                                                </div>
                                    ...
                                    <div class="row">                                         <div class="col-md-4 col-lg-4">
                                      ...
                                      ?>
                                                <input type="text" value="<?php echo $result; ?>" class="form-control"
                                                    onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"
                                                    disabled name="txtcanc" placeholder="">                                             </div>
                                        </div>                                     </div>                                     <hr>
                                    <div class="form-group">
                                        <div class="col-sm-12">                                             <a class="btn btn-danger text-white"
    ...
    function calcularMultiplicacion() {
        ...
        var numero2 = parseInt(document.getElementById('numero2').value);         // Calcular el resultado de la multiplicación
        var resultado = numero1 * numero2;         // Mostrar el resultado en el tercer campo de entrada
