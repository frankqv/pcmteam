...
<?php if (isset($_SESSION['id'])) { ?>
    ...
    <body>
        ...
        <?php include_once '../../backend/php/st_add_cart_compra.php' ?>
        <?php include_once '../../backend/php/st_updcart_compra.php' ?>
        <?php include_once '../../backend/php/st_addcheck_compra.php' ?>
