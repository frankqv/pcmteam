<!-- Plantilla de Archivo de mienstras tanto, Cuando la pagina Aun esta Constrccion -->
<?php
ob_start();
    session_start();
if(!isset($_SESSION['rol']) || !in_array($_SESSION['rol'], [1, 2, 3, 4, 6, 5 , 7, 8])){
...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <?php    include_once '../util/pag_pag_builder.php';    ?>
            <?php construcionpage(); ?>
        </div>
        <!---  Contenido de MAIN -->
        <!-- Optional JavaScript -->
