...
<?php if (isset($_SESSION['id'])) { ?>
    ...
    <html lang="es">     <head>
        ...
        <link rel="stylesheet" href="../assets/css/loader.css"> <!-- Data Tables -->
        <link rel="stylesheet" type="text/css" href="../assets/css/datatable.css">
        <link rel="stylesheet" type="text/css" href="../assets/css/buttonsdataTables.css">
        <link rel="stylesheet" type="text/css" href="../assets/css/font.css"> <!-- SLIDER REVOLUTION 4.x CSS SETTINGS -->
                            ...
                            <div class="card" style="min-height: 485px">
                                <div class="card-header card-header-text">
                                    ...
                                    <p class="category">Servicio añadido</p>
                                        ...
                                        ?> <?php if (count($data) > 0) : ?> <table class="table table-hover" id="example">
                                        ...
                                        <tbody>
                                            <?php foreach ($data as $g) : ?>
                                                <tr>
                                                    <td><img src="../assets/img/subidas/<?php echo $g->foto ?>" hight='90'
                                                    ...
                                                    <td><?php echo  $g->nomcli; ?>&nbsp;<?php echo  $g->apecli; ?></td> <?php if ($g->estod == 'Activo') { ?> <td style="color: #3e5569;"><strong><?php echo  $g->ini; ?> -
                                                                <?php echo  $g->fin; ?></strong></td>
                                                    <?php } else { ?>
                                                        <td style="color: #3e5569;">
                                                            <span class="text-dark"><strong>Finalizado</strong></span>
                                                        </td>
                                                    <?php } ?> <td style="color: #3e5569;">
                                                        <?php
                                                        $esta = $g->estod;
                                                        $fechaEnvio = $g->fin;
                                                    ...
                                                    <td>
                                                        <a class="btn btn-secondary text-white" target="_blank"
                                                            href="https://api.whatsapp.com/send/?phone=573222024365&text=%C2%A1%20Te%20damos%20la%20bienvenida%20nuevamente%20a%20PCMarkett%20SAS%21"><i
                                                                class='material-icons' data-toggle='tooltip'
                                                                title='WhatsApp'>smartphone</i></a>
                                                        <a class="btn btn-info text-white" href="../servicio/ticket.php?id=8"><i
                                                                class='material-icons' data-toggle='tooltip'
                                                ...
                                                <td>
                                                    <?php if ($g->estod == 'Activo') { ?> <?php } else { ?>
                                                    <?php } ?>
                                                </td>
                                                </tr>
                                            <?php endforeach; ?>
                                    ...
                                    <!--fin de table-->
                                <?php else : ?> <!-- Warning Alert -->
                                    <div class="alert alert-warning" role="alert">
                                        No se encontró ningún dato!
                                    </div> <?php endif; ?>
                            </div>
                            <!--FIN de div card-content table-responsive -->
                        </div>
                    </div>
                </div>
            </div>
