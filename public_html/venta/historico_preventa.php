...
<head>
    ...
    <title>Hist�rico de Solicitudes - PCMARKETTEAM</title>
...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="alert alert-<?php echo $tipo_mensaje === 'success' ? 'success' : 'danger'; ?> alert-dismissible fade show" role="alert">
                            <strong><?php echo $tipo_mensaje === 'success' ? '��xito!' : '�Error!'; ?></strong> <?php echo htmlspecialchars($mensaje); ?>
                                        ...
                                        <div class="timeline-content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <p class="mb-1"><strong>T�cnico:</strong> <?php echo htmlspecialchars($solicitud['tecnico_nombre']); ?></p>
                                                    <?php endif; ?>
                                                </div>
                                            </div>

                                            <p class="mb-1 mt-2"><strong>Descripci�n:</strong></p>
            ...
            <div class="modal-content">
                ...
                <form method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Descripci�n de Requerimientos <span class="text-danger">*</span></label>
                            <textarea name="descripcion" class="form-control" rows="4" required
                                      placeholder="Describe las especificaciones t�cnicas requeridas (procesador, RAM, disco, pantalla, etc.)"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Observaciones</label>
                            <textarea name="observacion" class="form-control" rows="3"
                                      placeholder="Informaci�n adicional o comentarios"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
    ...
    <script type="text/javascript">
        ...
        $('.btn-ver-detalle').on('click', function() {
            ...
            $('#det-descripcion').text(solicitud.descripcion || 'Sin descripción');
            ...
            $('#det-observacion-tecnico').text(solicitud.observacion_tecnico || 'Sin observaciones del técnico');
