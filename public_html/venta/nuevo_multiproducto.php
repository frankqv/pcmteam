    ...
    <div class="wrapper">
                            ...
                            <div class="col-lg-7">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Carrito y Datos de la Venta</h4>
                                    </div>
                                    <div class="card-body">
        ...
        <script>
            $(document).ready(function() {
                ...
                const mensajeError = "<?php echo isset($_SESSION['mensaje_error']) ? $_SESSION['mensaje_error'] : '';
                                        unset($_SESSION['mensaje_error']); ?>";
                const mensajeExito = "<?php echo isset($_SESSION['mensaje_exito']) ? $_SESSION['mensaje_exito'] : '';
