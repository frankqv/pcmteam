...
<body>
                                            ...
                                            if ($result && $result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo "<td class='text-center'>
                                                        ...
                                                        <a href='javascript:void(0)' class='btn btn-success btn-sm add-vender-btn' data-id='" . $row['id'] . "' title='Mandar a Productos'><i class='material-icons'>price_check</i></a>";
                                                    if (!isset($row['precio']) || $row['precio'] === '' || $row['precio'] === '0') {
    ...
    <script>
        $(document).ready(function() {
            ...
            // VEnder a Productos
            $(document).on('click', '.add-vender-btn', function() {
                var id = $(this).data('id');
                $.ajax({
                    // hacer una funcion para vender este equipo o que te mande  a la pagina donde puedes ir  a vender los 
                    // equipos esta en la ruta, "http://192.168.2.10/pcmteam/public_html/venta/nuevo.php" la cual tenesmo tambien modificar
                });
