                                ...
                                <form enctype="multipart/form-data" method="POST" autocomplete="off">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-lg-4">
                                            <div class="form-group">
                                                <label for="email">Nombre del servicio<span
                                                        class="text-danger">*</span></label>
                                                <input type="text" readonly value="<?php echo  $f->nompla  ; ?>"
                                                    class="form-control" name="txtnampla"
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="form-group">
                                                <label for="email">Precio del servicio<span
                                                        class="text-danger">*</span></label>
                                                <input type="text" value="<?php echo  $f->prec  ; ?>"
                                                    onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"
                                                    class="form-control" name="txtprepl" readonly
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" readonly name="txtesta">
                                                    <option value="<?php echo  $f->estp  ; ?>">
                                                        <?php echo  $f->estp  ; ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
