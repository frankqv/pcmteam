                        ...
                        <div class="col-lg-12 col-md-12">
                            ...
                            <div class="card" style="min-height: 485px">
                                <div class="card-header card-header-text">
                                    ...
                                    <p class="category">Actualizar imagen del servicio reciente añadidos el dia de hoy</p>
                                </div>
                                                    ...
                                                    <div class="col-md-12 col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" readonly value="<?php echo  $f->nompla; ?>"
                                                                class="form-control" name="txtnampla" required
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-lg-12">
                                                        <div class="form-group">
                                                            ...
                                                            <img id="blah" src="../assets/img/subidas/<?php echo $f->foto; ?>"
