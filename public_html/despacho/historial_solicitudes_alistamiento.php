...
$sql_stats = "SELECT
    ...
    SUM(CASE WHEN estado = 'entrega_parcial' THEN 1 ELSE 0 END) as entrega_parcial,
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <select name="filtro_estado" class="form-control" onchange="this.form.submit()">
                        ...
                        <option value="Entrega_parcial" <?php echo $filtro_estado === 'Entrega_parcial' ? 'selected' : ''; ?>>Entrega Parcial</option>
                      ...
                      <tr>
                        ...
                        <td>
                          <select class="form-control form-control-sm estado-select" data-solicitud-id="<?php echo $sol['id']; ?>" style="min-width: 140px;">
                            ...
                            <option value="entrega_parcial" <?php echo $sol['estado'] === 'entrega_parcial' ? 'selected' : ''; ?>>Entrega Parcial</option>
