...
<head>
    ...
    <title>PCMARKETTEAM - Mis Clientes</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="main-content">
                ...
                // Obtener el idsede del usuario actual
                $userIdSede = null;
                $userName = 'Usuario';

                try {
                    $sqlUserInfo = "SELECT idsede, nombre FROM usuarios WHERE id = :id LIMIT 1";
                        ...
                        <div class="card" style="min-height: 485px">
                            ...
                            <div class="card-content table-responsive">
                                ...
                                if (empty($userIdSede)) {
                                    ...
                                    // Construir query según el idsede del usuario
                                    if ($userIdSede === "Todo") {
                                ...
                                <div class="alert alert-warning" role="alert">
                                    ...
                                    if ($userIdSede === "Todo") {
                                        ...
                                        echo "No se encontraron clientes para tu sede: " . htmlspecialchars($userIdSede);
                                    }
                                    ?>
                                </div>
                                <?php endif; ?>
