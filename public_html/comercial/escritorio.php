...
// Mis ventas del mes (nueva tabla new_alistamiento_venta)
$sql_ventas_mes = "SELECT COUNT(*) as total_ventas,
                   COALESCE(SUM(total_venta), 0) as total_dinero
      ...
      <div class="top-navbar">
        <nav class="navbar navbar-expand-lg">
          <div class="container-fluid">
            <button type="button" class="d-xl-block d-lg-block d-md-none d-none">
              <span class="material-icons">arrow_back_ios</span>
            </button>
            <?php
            // Obtener la hora actual en UTC-5 (Colombia)
            date_default_timezone_set('America/bogota');
            $hora = (int)date('G'); // Hora en formato 24 horas (0-23)
            ...
            <div>
              <strong><?php echo $emoji; ?> ¡<?php echo $saludo; ?>, </strong>
              ...
              <div class="card dashboard-card">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <a href="historico_venta.php" class="text-decoration-none">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <a href="historico_venta.php" class="btn btn-outline-success btn-block">
